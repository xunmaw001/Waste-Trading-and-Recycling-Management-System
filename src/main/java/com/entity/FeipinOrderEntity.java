...
public class FeipinOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FeipinOrderEntity() {

	}

	public FeipinOrderEntity(T t) {
		try {
     ...
     * 废品
     */
    @ColumnInfo(comment="废品",type="int(11)")
    ...
    public String toString() {
        return "FeipinOrder{" +
            ...
            ", feipinId=" + feipinId +
            ", yonghuId=" + yonghuId +
            ", feipinOrderTypes=" + feipinOrderTypes +

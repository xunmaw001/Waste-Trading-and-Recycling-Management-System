...
*/
@TableName("feipin")
public class FeipinView extends FeipinEntity implements Serializable {
	...
	*/
	...
	public FeipinView(FeipinEntity feipinEntity) {
		try {
			BeanUtils.copyProperties(this, feipinEntity);

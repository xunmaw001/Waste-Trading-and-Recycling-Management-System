...
var centerMenu = [
    ...
    ,{
        name: '废品订单',
        url: '../feipinOrder/list.html'
    },
    {
        name: '废品',
        url: '../feipin/list2.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/feipinmaimaihuishouguanlixitong/admin/dist/index.html#/login";
